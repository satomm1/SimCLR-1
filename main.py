...
if __name__ == '__main__':
    ...
    train_data = utils.MeltpoolDataset('../train.xlsx', '../imagesPNGSmall/train/', transform=utils.train_transform)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if train_loss < min_train_loss:
            torch.save(model.state_dict(), 'results/{}_model.pth'.format(save_name_pre), _use_new_zipfile_serialization=False)
